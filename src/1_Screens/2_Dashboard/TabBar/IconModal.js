...
import { CardModalComponent } from "../../../2_Components/2_screenConponents/AddBill/CardModalComponent";
import { IconModalComponent } from "../../../2_Components/2_screenConponents/AddBill";
...
class IconModal extends Component {
  ...
  closeModal(icon) {
    ...
    Animated.timing(this.state.modalHeight, {
      ...
      if (finished) {
        if (icon === undefined) {
          console.log("icon option is undefined");
          this.props.navigation.goBack();
        } else {
          this.props.navigation.goBack();
          this.props.navigation.state.params.getSelectedIcon({
            icon
          });
        }
      }
      ...
      >
        ...
        >
          <View style={styles.dragableViewContainer}>
            <IconModalComponent onSelect={this.onSelect} />
          </View>
        </Animated.View>
      </View>
    );
