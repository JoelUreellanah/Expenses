...
import { BillTypeModalComponent } from "../../../2_Components/2_screenConponents/AddBill";

class BillTypeModal extends Component {
  constructor(props) {
    super(props);
    ...
    Animated.timing(this.state.modalHeight, {
      ...
      if (finished) {
        if (contractType === undefined) {
          ...
          this.props.navigation.goBack();
          this.props.navigation.state.params.getBillType({ contractType });
        }
      }
    });
  }
      ...
      >
        ...
        >
          <View style={styles.dragableViewContainer}>
            ...
            >
              <BillTypeModalComponent onSelect={this.onSelect} />
            </KeyboardAwareScrollView>
          </View>
        </Animated.View>
      </View>
