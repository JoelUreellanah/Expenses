...
class CardModal extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      cardKey: this.props.navigation.state.params.cardKey
    };
  }
  ...
  closeModal(cardKey, cardName, cardNumber, cardIcon) {
    Animated.spring(this.state.opacity, {
      toValue: 0
    }).start(({ finished }) => {
      if (finished) {
  ...
  onSelect = (cardKey, cardName, cardNumber, cardIcon) => {
    // console.warn(cardKey);
    this.closeModal(cardKey, cardName, cardNumber, cardIcon);
  };
