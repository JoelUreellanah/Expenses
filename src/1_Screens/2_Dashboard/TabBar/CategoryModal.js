...
import CategoryModalComponent from "../../../2_Components/2_screenConponents/AddBill/CategoryModalComponent";
    ...
    Animated.timing(this.state.modalHeight, {
      ...
      if (finished) {
        if (category === undefined) {
          console.log("category option is undefined");
          this.props.navigation.goBack();
        } else {
          this.props.navigation.goBack();
          this.props.navigation.state.params.getSelectedCategory({
            category
          });
        }
      }
