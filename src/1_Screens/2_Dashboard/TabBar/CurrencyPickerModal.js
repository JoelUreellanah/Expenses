...
import { CurrencyPickerModalComponent } from "../../../2_Components/2_screenConponents/AddBill";

class CurrencyPickerModal extends Component {
  constructor(props) {
    super(props);
    ...
    Animated.timing(this.state.modalHeight, {
      ...
      if (finished) {
        if (currency === undefined) {
          ...
          this.props.navigation.goBack();
          this.props.navigation.state.params.getSelectedCurrency({ currency });
        }
      }
    });
  }
      ...
      >
        ...
        >
          <View style={styles.dragableViewContainer}>
            ...
            >
              <CurrencyPickerModalComponent onSelect={this.onSelect} />
            </KeyboardAwareScrollView>
          </View>
        </Animated.View>
      </View>
