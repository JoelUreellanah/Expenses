    ...
    this.panResponder = PanResponder.create({
      ...
      onPanResponderRelease: (evt, gestureState) => {
        ...
        if (gestureState.dx < 2 && gestureState.dx > -2) {
          ...
          // if trying to open left side but threshold not achieved
          else if (
            this.position.x._value > 0 &&
            this.position.x._value <= 30 &&
            !rightActionsOpen &&
          ...
          // open left side fully
          else if (
            this.position.x._value >= 31 &&
            !rightActionsOpen &&
            !leftActionsOpen
          ) {
            this.closeOnSwipe(100, 0, true, false, "settimo");
          }

          // if left side is open and user try to keep opening
          else if (
            this.position.x._value > 0 &&
            leftActionsOpen &&
            !rightActionsOpen
          ) {
            this.closeOnSwipe(0, 0, true, false, "ottavo");
          }

          // if trying to close left side but threshold not achieved
          else if (
            this.position.x._value < 0 &&
            this.position.x._value >= -30 &&
            leftActionsOpen &&
            ...
            this.closeOnSwipe(0, 0, true, false, "nono");
          }

          // if close left side fully
          else if (
            this.position.x._value <= -31 &&
            leftActionsOpen &&
            !rightActionsOpen
          ) {
            this.closeOnSwipe(-100, 0, false, false, "decimo");
          }
        }
      },
